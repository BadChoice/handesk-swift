...
extension Ticket {
    ...
    init(title:String,
        ...
        self.init(title:title, body:body, requester: requester, created_at: created_at, updated_at: updated_at, status: status, priority: priority, isBug: bug, isEscalated: escalated)
        }
}
